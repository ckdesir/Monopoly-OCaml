...
let int_list_printer lst = 
  ...
  | "" -> "[]"
  | str -> "[" ^ (String.sub str 0 (String.length str - 2)) ^ "]" in
  let rec print_list = function
  | [] -> ""
  | h ::t -> string_of_int h ^ "; " ^ print_list t in
...
let mortgage_of_square_error test_name board name excption =
  test_name >:: fun _ -> 
  assert_raises (excption) 
  (fun () -> mortgage_of_square board name)

let position_of_square_test test_name board name expected_output =
  test_name >:: fun _ ->
  assert_equal expected_output 
  (position_of_square board name) ~printer:int_list_printer
...
let set_of_square_test test_name board name expected_output =
  test_name >:: fun _ ->
  assert_equal expected_output 
  (set_of_square board name) ~printer:String.escaped

let set_of_square_error test_name board name excption =
  test_name >:: fun _ -> 
  assert_raises (excption) 
  (fun () -> set_of_square board name)
...
let get_community_chest_card_error test_name board excption =
  test_name >:: fun _ -> 
  assert_raises (excption) 
  (fun () -> get_community_chest_card board)
...
let position_of_square_compilation =
  [
    ...
    position_of_square_test "community chest" basic_board "Community Chest"
    [2; 17; 33];
...
let cost_of_square_compilation =
  [
    cost_of_square_test "valid railroad" basic_board "Pennsylvania Railroad" 
    200;
    ...
    "Short Line" (InvalidSquare ("Railroad", "Short Line"));
    ...
    "Baltic Avenue - Bad"(InvalidSquare ("Street", "Baltic Avenue - Bad"));
    cost_of_square_error "valid street, null cost" faulty_board 
    "Park Place" (InvalidSquare ("Street", "Park Place"));
   ...
   cost_of_square_error "valid income tax, null cost" faulty_board 
    "Income Null" (InvalidSquare ("Income Tax", "Income Null"));
    ...
    "Luxury Tax - Bad" (InvalidSquare ("Luxury Tax", "Luxury Tax - Bad"));
    cost_of_square_error "valid luxury tax, null cost" faulty_board 
    "Luxury Null" (InvalidSquare ("Luxury Tax", "Luxury Null"));
    ...
    "Water Works - Bad" (InvalidSquare ("Utility", "Water Works - Bad"));
    cost_of_square_error "valid water works, null cost" faulty_board 
    "Water Null" (InvalidSquare ("Utility", "Water Null"));
...
let type_of_square_test_compilation = [
  ...
  type_of_square_error "invalid square" basic_board "go" (UnknownSquare "go");
  type_of_square_error "invalid square" faulty_board "Pennsylvania Railroad" 
  (UnknownType "Not Railroad");
]
...
let mortgage_of_square_compilation =
  [
    ...
    mortgage_of_square_error "valid railroad, mismatch type" faulty_board 
    "Pennsylvania Railroad" (UnknownType "Not Railroad");
    mortgage_of_square_error "valid railroad, no mortgage" faulty_board 
    "Reading Railroad - Bad" 
    (InvalidSquare ("Railroad", "Reading Railroad - Bad"));
    mortgage_of_square_error "valid railroad, null mortgage" faulty_board 
    "Short Line" (InvalidSquare ("Railroad", "Short Line"));
    ...
    mortgage_of_square_error "valid water works, mismatch type" faulty_board 
    "Water Works" (UnknownType "utility");
    mortgage_of_square_error "valid water works, no mortgage" faulty_board 
    "Water Works - Bad" (InvalidSquare ("Utility", "Water Works - Bad"));
    mortgage_of_square_error "valid water works, null mortgage" faulty_board 
    "Water Null" (InvalidSquare ("Utility", "Water Null"));

    mortgage_of_square_error "invalid type - go" basic_board "Go" 
    (TypeMismatch "Go");
    mortgage_of_square_error "invalid type - jail/just visiting" basic_board 
    "Jail/Just Visiting" (TypeMismatch "Jail/Just Visiting");
    mortgage_of_square_error "invalid type - chance" basic_board 
    "Chance" (TypeMismatch "Chance");
    mortgage_of_square_error "invalid type - community chest" basic_board 
    "Community Chest" (TypeMismatch "Community Chest");
...
let set_of_square_compilation =
  [
    set_of_square_test "valid railroad" basic_board "Pennsylvania Railroad" 
    "Railroad";
    set_of_square_error "invalid railroad" basic_board "pennsylvania railroad" 
    (UnknownSquare "pennsylvania railroad");
    ...
    "Water Works - Bad" (InvalidSquare ("Utility", "Water Works - Bad"));
    set_of_square_error "valid water works, null set" faulty_board "Water Null" 
    ...
    "Jail/Just Visiting" (TypeMismatch "Jail/Just Visiting");
    set_of_square_error "invalid type - chance" basic_board 
    "Chance" (TypeMismatch "Chance");
...
let upgrade_cost_compilation =
  [
    upgrade_cost_test "valid street" basic_board "Mediterranean Avenue" 50;
    ...
    "Jail/Just Visiting" (TypeMismatch "Jail/Just Visiting");
    upgrade_cost_error "invalid type - chance" basic_board 
    "Chance" (TypeMismatch "Chance");
    ...
    "Income Tax" (TypeMismatch "Income Tax");
    upgrade_cost_error "invalid type - railroad" basic_board "Reading Railroad" 
    (TypeMismatch "Railroad");
...
let cost_of_tier_0_compilation =
  [
    ...
    "pennsylvania railroad" (UnknownSquare "pennsylvania railroad");
    cost_of_tier_0_rent_error "valid railroad, mismatch type" faulty_board 
    "Pennsylvania Railroad" (UnknownType "Not Railroad");
    cost_of_tier_0_rent_error "valid railroad, no rent tiers period" 
    faulty_board "Short Line" (InvalidSquare ("Railroad", "Short Line"));
    cost_of_tier_0_rent_error "valid railroad, no cost period" 
    faulty_board "Big Bertha" (InvalidSquare ("Railroad", "Big Bertha"));
    cost_of_tier_0_rent_error "valid railroad, no tier period" 
    faulty_board "Thomas" (InvalidSquare ("Railroad", "Thomas"));
    cost_of_tier_0_rent_error "valid railroad, null tier" 
    faulty_board "B. & O. Railroad" 
    (InvalidSquare ("Railroad", "B. & O. Railroad"));
    cost_of_tier_0_rent_error "valid railroad, null cost" 
    ...
    cost_of_tier_0_rent_error "valid street, null tier" 
    faulty_board "Boardwalk" 
    (InvalidSquare ("Street", "Boardwalk"));
    cost_of_tier_0_rent_error "valid street, null cost" 
    faulty_board "Park Place" 
    (InvalidSquare ("Street", "Park Place"));

    cost_of_tier_0_rent_error "invalid type - go" basic_board "Go" 
    (TypeMismatch "Go");
    cost_of_tier_0_rent_error "invalid type - jail/just visiting" basic_board 
    "Jail/Just Visiting" (TypeMismatch "Jail/Just Visiting");
    cost_of_tier_0_rent_error "invalid type - chance" basic_board 
    "Chance" (TypeMismatch "Chance");
    cost_of_tier_0_rent_error "invalid type - community chest" basic_board 
    "Community Chest" (TypeMismatch "Community Chest");
    ...
    "Income Tax" (TypeMismatch "Income Tax");
    cost_of_tier_0_rent_error "invalid type - go" basic_board "Water Works" 
    (TypeMismatch "Utility");
  ]
...
let cost_of_tier_1_compilation =
  [
    ...
    "pennsylvania railroad" (UnknownSquare "pennsylvania railroad");
    cost_of_tier_1_rent_error "valid railroad, mismatch type" faulty_board 
    "Pennsylvania Railroad" (UnknownType "Not Railroad");
    ...
    faulty_board "Thomas" (InvalidSquare ("Railroad", "Thomas"));
    cost_of_tier_1_rent_error "valid railroad, null tier" 
    faulty_board "B. & O. Railroad" 
    (InvalidSquare ("Railroad", "B. & O. Railroad"));
    cost_of_tier_1_rent_error "valid railroad, null cost" 
    faulty_board "Reading Railroad" 
    (InvalidSquare ("Railroad", "Reading Railroad"));
    ...
    faulty_board "Vermont Avenue" 
    (InvalidSquare ("Street", "Vermont Avenue"));
    cost_of_tier_1_rent_error "valid street, null tier" 
    faulty_board "Boardwalk" 
    (InvalidSquare ("Street", "Boardwalk"));
    cost_of_tier_1_rent_error "valid street, null cost" 
    faulty_board "Park Place" 
    (InvalidSquare ("Street", "Park Place"));

    cost_of_tier_1_rent_error "invalid type - go" basic_board "Go" 
    (TypeMismatch "Go");
    cost_of_tier_1_rent_error "invalid type - jail/just visiting" basic_board 
    "Jail/Just Visiting" (TypeMismatch "Jail/Just Visiting");
    cost_of_tier_1_rent_error "invalid type - chance" basic_board 
    "Chance" (TypeMismatch "Chance");
    cost_of_tier_1_rent_error "invalid type - community chest" basic_board 
    "Community Chest" (TypeMismatch "Community Chest");
    ...
    "Income Tax" (TypeMismatch "Income Tax");
    cost_of_tier_1_rent_error "invalid type - go" basic_board "Water Works" 
    (TypeMismatch "Utility");
  ]
...
let cost_of_tier_2_compilation =
  [
    ...
    "pennsylvania railroad" (UnknownSquare "pennsylvania railroad");
    cost_of_tier_2_rent_error "valid railroad, mismatch type" faulty_board 
    "Pennsylvania Railroad" (UnknownType "Not Railroad");
    ...
    faulty_board "Thomas" (InvalidSquare ("Railroad", "Thomas"));
    cost_of_tier_2_rent_error "valid railroad, null tier" 
    faulty_board "B. & O. Railroad" 
    (InvalidSquare ("Railroad", "B. & O. Railroad"));
    cost_of_tier_2_rent_error "valid railroad, null cost" 
    faulty_board "Reading Railroad" 
    (InvalidSquare ("Railroad", "Reading Railroad"));
    ...
    faulty_board "Vermont Avenue" 
    (InvalidSquare ("Street", "Vermont Avenue"));
    cost_of_tier_2_rent_error "valid street, null tier" 
    faulty_board "Boardwalk" 
    (InvalidSquare ("Street", "Boardwalk"));
    cost_of_tier_2_rent_error "valid street, null cost" 
    faulty_board "Park Place" 
    (InvalidSquare ("Street", "Park Place"));

    cost_of_tier_2_rent_error "invalid type - go" basic_board "Go" 
    (TypeMismatch "Go");
    cost_of_tier_2_rent_error "invalid type - jail/just visiting" basic_board 
    "Jail/Just Visiting" (TypeMismatch "Jail/Just Visiting");
    cost_of_tier_2_rent_error "invalid type - chance" basic_board 
    "Chance" (TypeMismatch "Chance");
    cost_of_tier_2_rent_error "invalid type - community chest" basic_board 
    "Community Chest" (TypeMismatch "Community Chest");
    ...
    "Income Tax" (TypeMismatch "Income Tax");
    cost_of_tier_2_rent_error "invalid type - go" basic_board "Water Works" 
    (TypeMismatch "Utility");
  ]
  ...
  [
    ...
    "pennsylvania railroad" (UnknownSquare "pennsylvania railroad");
    cost_of_tier_3_rent_error "valid railroad, mismatch type" faulty_board 
    "Pennsylvania Railroad" (UnknownType "Not Railroad");
    ...
    faulty_board "Thomas" (InvalidSquare ("Railroad", "Thomas"));
    cost_of_tier_3_rent_error "valid railroad, null tier" 
    faulty_board "B. & O. Railroad" 
    (InvalidSquare ("Railroad", "B. & O. Railroad"));
    cost_of_tier_3_rent_error "valid railroad, null cost" 
    faulty_board "Reading Railroad" 
    (InvalidSquare ("Railroad", "Reading Railroad"));
    ...
    faulty_board "Vermont Avenue" 
    (InvalidSquare ("Street", "Vermont Avenue"));
    cost_of_tier_3_rent_error "valid street, null tier" 
    faulty_board "Boardwalk" 
    (InvalidSquare ("Street", "Boardwalk"));
    cost_of_tier_3_rent_error "valid street, null cost" 
    faulty_board "Park Place" 
    (InvalidSquare ("Street", "Park Place"));

    cost_of_tier_3_rent_error "invalid type - go" basic_board "Go" 
    (TypeMismatch "Go");
    cost_of_tier_3_rent_error "invalid type - jail/just visiting" basic_board 
    "Jail/Just Visiting" (TypeMismatch "Jail/Just Visiting");
    cost_of_tier_3_rent_error "invalid type - chance" basic_board 
    "Chance" (TypeMismatch "Chance");
    cost_of_tier_3_rent_error "invalid type - community chest" basic_board 
    "Community Chest" (TypeMismatch "Community Chest");
    ...
    "Income Tax" (TypeMismatch "Income Tax");
    cost_of_tier_3_rent_error "invalid type - go" basic_board "Water Works" 
    (TypeMismatch "Utility");
  ]
...
let cost_of_tier_4_compilation =
  [
    ...
    faulty_board "Vermont Avenue" 
    (InvalidSquare ("Street", "Vermont Avenue"));
    cost_of_tier_4_rent_error "valid street, null tier" 
    faulty_board "Boardwalk" 
    (InvalidSquare ("Street", "Boardwalk"));
    cost_of_tier_4_rent_error "valid street, null cost" 
    faulty_board "Park Place" 
    (InvalidSquare ("Street", "Park Place"));

    cost_of_tier_4_rent_error "invalid type - go" basic_board "Go" 
    (TypeMismatch "Go");
    cost_of_tier_4_rent_error "invalid type - jail/just visiting" basic_board 
    "Jail/Just Visiting" (TypeMismatch "Jail/Just Visiting");
    cost_of_tier_4_rent_error "invalid type - chance" basic_board 
    "Chance" (TypeMismatch "Chance");
    cost_of_tier_4_rent_error "invalid type - community chest" basic_board 
    "Community Chest" (TypeMismatch "Community Chest");
    ...
    "Income Tax" (TypeMismatch "Income Tax");
    cost_of_tier_4_rent_error "invalid type - go" basic_board "Water Works" 
    (TypeMismatch "Utility");
...
let cost_of_tier_5_compilation =
  [
    ...
    faulty_board "Vermont Avenue" 
    (InvalidSquare ("Street", "Vermont Avenue"));
    cost_of_tier_5_rent_error "valid street, null tier" 
    faulty_board "Boardwalk" 
    (InvalidSquare ("Street", "Boardwalk"));
    cost_of_tier_5_rent_error "valid street, null cost" 
    faulty_board "Park Place" 
    (InvalidSquare ("Street", "Park Place"));

    cost_of_tier_5_rent_error "invalid type - go" basic_board "Go" 
    (TypeMismatch "Go");
    cost_of_tier_5_rent_error "invalid type - jail/just visiting" basic_board 
    "Jail/Just Visiting" (TypeMismatch "Jail/Just Visiting");
    cost_of_tier_5_rent_error "invalid type - chance" basic_board 
    "Chance" (TypeMismatch "Chance");
    cost_of_tier_5_rent_error "invalid type - community chest" basic_board 
    "Community Chest" (TypeMismatch "Community Chest");
    ...
    "Income Tax" (TypeMismatch "Income Tax");
    cost_of_tier_5_rent_error "invalid type - go" basic_board "Water Works" 
    (TypeMismatch "Utility");
...
let suite =
  ...
  position_of_square_compilation; type_of_square_test_compilation;
  mortgage_of_square_compilation; set_of_square_compilation; 
  upgrade_cost_compilation; cost_of_tier_0_compilation; 
  cost_of_tier_1_compilation; cost_of_tier_2_compilation; 
  cost_of_tier_3_compilation; cost_of_tier_4_compilation; 
  cost_of_tier_5_compilation; chance_community_compilation; field_tests;
  mutable_balance_tests; square_tests; trade_test; trade_two_tests; jail_tests; ]
